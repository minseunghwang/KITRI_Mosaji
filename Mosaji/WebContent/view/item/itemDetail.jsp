...
<!-- 								
						...
						<li data-v-991c3c50=""
							class="contents__product-info__li contents__product-info__text"><section
								...
								<div data-v-7c039372="" class="product-main-info__data_wrapper">
									<div data-v-7c039372="" class="product-main-info__volume_price">
										...
										<div data-v-7c039372="" class="ratings__heart_graph">
											<ul data-v-4385e41e="" data-v-7c039372="">
												<li data-v-4385e41e=""><article data-v-14354dc6=""
														...
														<div data-v-14354dc6="" class="wrap" style="width: 100%;">
								...
								<div data-v-7c039372=""
									...
									<span data-v-7c039372="" class="brand_info__brand-name">${i.i_brand }</span>
										...
										<button type="button" class = "btn btn-outline-secondary" onclick="window.open('https://search.shopping.naver.com/search/all?query=${i.i_name}&cat_id=&frm=NVSHATC') ">네이버 쇼핑연결</button>
										<button type="button" class = "btn btn-outline-secondary" onclick="https://search.naver.com/search.naver?sm=top_hty&fbm=1&ie=utf8&query=${i.i_brand}') ">브랜드 명으로 검색하기</button>
